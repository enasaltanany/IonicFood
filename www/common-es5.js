...
/***/ "./src/app/recipies/recipes.service.ts":
/*!*********************************************!*\
  !*** ./src/app/recipies/recipes.service.ts ***!
  \*********************************************/
...
var RecipesService = /** @class */ (function () {
    ...
    RecipesService.prototype.getRecipe = function (recipieId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.recipies.find(function (recipe) {
            return recipe.id === recipieId;
        }));
    };
    RecipesService.prototype.deleteRecipe = function (recipieId) {
